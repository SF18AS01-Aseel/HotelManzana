...
//  HotelManzana
//
//  Created by Aseel Alshohatee on 3/6/19.
...
class RegistrationTableViewController: UITableViewController {
    ...
    // the model of the this view controller
...
// this what give us the sections
    ...
    override func prepare(for segue: UIStoryboardSegue, sender:
        ...
        guard segue.identifier == "EditRegistration" else { return }
        guard let navigationController: UINavigationController =  segue.destination as?
            UINavigationController else {
                fatalError("EditRegistration segue is suposed to go to a UIUINavigationController")
        }
        guard let addRegistrationTableViewController: AddRegistrationTableViewController =
            navigationController.topViewController as? AddRegistrationTableViewController else {
                fatalError("AddRegistrationTableViewController")
        }
